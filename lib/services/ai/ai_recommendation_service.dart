...
class AIRecommendationService {
  ...
  List<RecommendationResult> recommend({required String category, String? location}) {
    final matches = MockData.providers.where((provider) => provider.category.toLowerCase().contains(category.toLowerCase()) || category.toLowerCase().contains('empaque')).toList();
    final ranked = matches.isEmpty ? MockData.providers : matches;
